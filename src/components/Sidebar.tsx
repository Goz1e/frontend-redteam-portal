...
export function Sidebar({ activeTab, setActiveTab, isOpen, setIsOpen, onBackToLanding }: SidebarProps) {
  ...
  const navigation = [
    ...
    { id: 'profiles', label: 'Miner Profiles', icon: Users },
      ...
      <div className="p-4 border-b border-sidebar-border flex items-center justify-between">
        <AnimatePresence mode="wait">
          {isOpen && (
            ...
            >
              <span className="text-sm font-medium text-muted-foreground">REDTEAM</span>
              <button
          ...
          return (
            ...
            >
              <motion.button
                ...
                className={`w-full justify-start relative group rounded-md px-3 py-2 transition-all duration-200 flex items-center ${
                  isActive 
